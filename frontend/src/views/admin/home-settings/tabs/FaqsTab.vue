...
const fields = [
  { key: 'question', label: 'Savol',  type: 'multilingual', required: true },
  { key: 'answer',   label: 'Javob',  type: 'multilingual-textarea', rows: 5, required: true },
  { key: 'enabled',    label: 'Faol', type: 'checkbox' },
  { key: 'sort_order', label: 'Tartib', type: 'number' }
]
const columns = [
  { key: 'question_uz', label: 'Savol' },
...
<template>
  <CollectionEditor
    title="FAQ — Savol va javoblar"
    description="Bosh sahifadagi tez-tez beriladigan savollar"
    :api="AdminHomeAPI.faqs"
    :fields="fields"
