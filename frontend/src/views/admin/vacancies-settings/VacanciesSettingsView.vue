...
import { LayoutPanelLeft, Briefcase } from 'lucide-vue-next'

import HeroTab from './tabs/HeroTab.vue'
import VacanciesTab from './tabs/VacanciesTab.vue'

const route = useRoute()
const router = useRouter()

const tabs = [
  { key: 'hero',      label: 'Sahifa sozlamalari', icon: LayoutPanelLeft, component: HeroTab },
  { key: 'vacancies', label: 'Vakansiyalar',        icon: Briefcase,       component: VacanciesTab }
]
...
<template>
  <div>
    <div class="mb-6">
      <h1 class="text-xl font-display font-bold text-ink-dark dark:text-white">Vakansiyalar sahifasi</h1>
      <p class="text-sm text-ink-faint mt-0.5">Hero, CV CTA va vakansiyalar ro'yxati</p>
    </div>
