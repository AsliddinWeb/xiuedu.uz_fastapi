...
FACULTIES = [
    ...
    dict(slug="pedagogika", icon="AcademicCapIcon",
         ...
         description_uz="Pedagogika, psixologiya, maktabgacha va boshlang'ich ta'lim, jismoniy madaniyat va musiqa",
         description_ru="Педагогика, психология, дошкольное и начальное образование, физкультура и музыка",
         description_en="Pedagogy, psychology, preschool and primary education, physical culture and music",
         programs=[
    ...
    # ── 479-102 · Tarix va filologiya fakulteti ──
    dict(slug="tarix-filologiya", icon="LanguageIcon",
         name_uz="Tarix va filologiya fakulteti",
         name_ru="Факультет истории и филологии",
         name_en="Faculty of History and Philology",
         description_uz="Tillarni o'qitish, tarix, jurnalistika va kutubxonashunoslik",
         description_ru="Обучение языкам, история, журналистика и библиотековедение",
         description_en="Language teaching, history, journalism and library studies",
         programs=[
    ...
    # ── 479-105 · Iqtisodiyot fakulteti ──
    dict(slug="iqtisodiyot", icon="ChartBarIcon",
         name_uz="Iqtisodiyot fakulteti",
         name_ru="Экономический факультет",
         name_en="Faculty of Economics",
         description_uz="Iqtisodiyot, moliya, buxgalteriya, axborot tizimlari, kommunal infra va yer tuzish",
         description_ru="Экономика, финансы, бухучёт, информационные системы, коммунальная инфраструктура и землеустройство",
         description_en="Economics, finance, accounting, information systems, communal infrastructure and land management",
         programs=[
    ...
    # ── 479-104 · Magistratura bo'limi ──
    dict(slug="magistratura", icon="TrophyIcon",
         name_uz="Magistratura bo'limi",
         name_ru="Отдел магистратуры",
         name_en="Master's Department",
         description_uz="Iqtisodiyot, pedagogika, psixologiya va lingvistika bo'yicha magistratura dasturlari",
         description_ru="Магистерские программы по экономике, педагогике, психологии и лингвистике",
         description_en="Master's programs in economics, pedagogy, psychology and linguistics",
         programs=[
